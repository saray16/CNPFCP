...
<div class="container py-4">
 <h1 class="text-center mb-4 fw-bold" style="color: #1a365d;">Panel de Administración</h1>
 ...
 <span class="badge" style="background: linear-gradient(135deg,rgb(46, 84, 153),rgb(36, 85, 158));">Administrador</span> 
 @else
 <span class="badge" style="background: linear-gradient(135deg, #3498db, #2980b9);">Usuario</span> 
 @endif
 </td>
 <td>
 ...
 @csrf
 <button type="submit" class="btn btn-sm btn-danger" title="Rechazar certificado">
 <i class="bi bi-x-lg"></i>
 </button>
 </form>
 <button class="btn btn-sm btn-primary" title="Ver detalles" data-bs-toggle="modal" data-bs-target="#detalleCertificadoModal" data-id="{{ $inscripcion->id }}">
 <i class="bi bi-eye-fill"></i>
 </button>
 </div>
 @else
 <button class="btn btn-sm btn-outline-secondary" title="Ver detalles" data-bs-toggle="modal" data-bs-target="#detalleCertificadoModal" data-id="{{ $inscripcion->id }}">
...
<style>
 ...
 #buscadorUsuarios, #buscadorGeneral {
 min-width: 200px;
 }
