@extends('layouts.app') @section('title', 'Formulario de Inscripción') @section('content') <div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <!-- Alertas --> @if (session('success')) <div class="alert alert-success alert-elegant alert-dismissible fade show" role="alert">
                <div class="d-flex align-items-center">
                    <i class="bi bi-check-circle-fill me-2 fs-4"></i>
                    <div>{{ session('success') }}</div>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div> @endif @if ($errors->any()) <div class="alert alert-danger alert-elegant alert-dismissible fade show" role="alert">
                <div class="d-flex align-items-center">
            ...
            <!-- Después de las alertas y antes del formulario --> @if(isset($actividadRecreacional) && $actividadRecreacional) <div class="card mb-4 shadow-sm" id="formacion-details" style="max-width: 700px; margin: auto; border: 1px solid #dbe9f6; background-color: #f8fbfd;">
            ...
            </div> @elseif(isset($formacion) && $formacion) <div class="card mb-4 shadow-sm" id="formacion-details" style="max-width: 700px; margin: auto; border: 1px solid #dbe9f6; background-color: #f8fbfd;">
                <div class="card-header" style="background-color: #1e3a8a; color: #fff; padding: 0.75rem 1rem;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="cedula" name="cedula" class="form-control" placeholder="Número" required value="{{ old('cedula') }}" pattern="\d{6,8}" title="Formato: 12345678 (6-8 dígitos)">
